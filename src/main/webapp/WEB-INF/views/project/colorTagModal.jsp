    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content row">
            ...
            <div class="modal-footer">
                <div class="col-lg-12 text-center">
                    <button type="button" class="btn btn-primary btn-lg mb-3" onclick="saveTag();">저장</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input type="text" id="addTagInput" class="form-control" placeholder="" aria-label="">
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="button" data-dismiss="modal" id="addTagBtn">추가
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content row">
            ...
            <form class="form" id="tagAdd">
                <div class="modal-body">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" id="tagEditInput"  aria-label="">
                            <div class="input-group-append">
                                <button class="btn btn-primary" id="editTagBtn" type="button" data-dismiss="modal">수정</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content row">
            ...
            <form class="form" id="pjColorsave">
                    ...
                    <table id="colorTable">
                        <tr>
                            <c:forEach var="index" begin="1" end="4">
                                <td>
                                    <div class="pjColors color-${index }">
                ...
                <div class="modal-footer">
                    <div class="col-lg-12 text-center">
                        <button type="button" class="btn btn-primary btn-lg mb-3" onclick="saveColor();">저장
                        </button>
                    </div>
                </div>
            </form>
