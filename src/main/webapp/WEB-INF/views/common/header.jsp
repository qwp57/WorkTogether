...
<!-- CSS Libraries -->
<link rel="stylesheet"
	href="resources/node_modules/jqvmap/dist/jqvmap.min.css">
<link rel="stylesheet"
	href="resources/node_modules/summernote/dist/summernote-bs4.css">
<link rel="stylesheet"
	href="resources/node_modules/owl.carousel/dist/assets/owl.carousel.min.css">
<link rel="stylesheet"
	href="resources/node_modules/owl.carousel/dist/assets/owl.theme.default.min.css">
...
<body>
		...
		<ul class="navbar-nav navbar-right">
			<li class="dropdown"><a href="#"
				...
				<div class="dropdown-menu dropdown-list dropdown-menu-right chat-tab-wrap"  style="display: none;">
					...
					<div class="dropdown-menu dropdown-list dropdown-menu-right  tel-tab-wrap">
					<div class="dropdown-header">
						<a id="chatNav" onclick="showChatList();">채팅</a> <a id="telNav" onclick="showTelList();" style="margin-left: 30px;">연락처</a>
			...
			<li class="dropdown"><a href="#" data-toggle="dropdown"
				...
				<div class="dropdown-menu dropdown-menu-right">
					...
					<a href="#" class="dropdown-item has-icon" id="profile"> <i
						class="far fa-user"></i> 내 정보
					</a>
					<!-- 관리자 설정은 관리자에게만 보인다. -->
					...
					</a> <a class="dropdown-item has-icon ml-3"
						href="departmentManagement.do"> <i
						class="bi bi-diagram-3-fill"></i>부서 관리
					</a> <a class="dropdown-item has-icon ml-3"
						href="employeeManagement.do"> <i class="bi bi-people-fill"></i>인사
						관리
					</a>
	...
	<div class="modal" id="myProfile" data-backdrop="static"
		data-keyboard="false">
		<div class="modal-dialog modal-xl modal-dialog-centered">
			<div class="modal-content row">
				<!-- modal header : 제목 -->
				<div class="modal-header">
					<span><h3 class="modal-title text-left">나의 기본 정보</h3></span> <span><input
					...
					<div class="modal-body">
						<table class="table-bordered" id="profileTable">
							<tr>
								...
								<td colspan="3" style="height: 40%"><img
									style="height: 100px" alt="image"
									src="resources/assets/img/avatar/avatar-1.png" id="profileImg"
									class="img-fluid m-3 rounded-circle"> <span
									class="filebox"> <label for="ex_file">+</label> <input
										type="file" id="ex_file"> <label for="ex_file">-</label>
										<input type="file" id="ex_file">
								</span></td>
							</tr>
							<tr>
								<th>&nbsp;이름</th>
								<td><input class="m-3" type="text" value="홍길동"
									name="empName"></td>
							...
							<tr>
								<th>&nbsp;부서</th>
								<td><input class="m-3" type="text" value="인사팀"
									name="empDept"></td>
								<th>&nbsp;직위</th>
							...
							<tr>
								...
								<td>
									<div class="input-group date" id="datetimepicker1"
										...
										<input type="text" class="form-control datetimepicker-input"
											data-target="#datetimepicker1" name="empBirth" />
								...
								<th>&nbsp;핸드폰 번호</th>
								<td><input class="m-3" type="tel" value="010-1111-2222"
									name="empTel"></td>
							</tr>
							<tr>
								<th>&nbsp;이메일</th>
								<td><input class="m-3" type="email" value="HONG@WT.COM"
									name="empEmail"></td>
								<th>&nbsp;입사일</th>
								<td>
									<div class="input-group date" id="datetimepicker2"
										data-target-input="nearest">
										<input type="text" class="form-control datetimepicker-input"
											data-target="#datetimepicker2" name="empJoinDate" />
