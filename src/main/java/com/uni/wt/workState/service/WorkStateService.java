...
public interface WorkStateService {
	...
	ArrayList<Map<String, Object>> departmentStats(int month, String type)throws Exception;

	ArrayList<Employee> bestEmployee(int month, String type) throws Exception;
