								...
								<tr class="thead-light">
									...
									<td class="text-left">
									 	<div class="input-group mb-3 input-group-sm">
											...
											<div class="input-group-prepend" style="width:100px">
												<select class="form-select border-1 rounded-0" id="searchDept" name="dept">
									...
									<td class="text-left">
										<div class="input-group mb-3 input-group-sm">
											...
											<div class="input-group-prepend" style="width:100px">
												<select class="form-select border-1 rounded-0" id="searchDeptUppper" name="deptUpper">
								...
								<tr class="thead-light">
									...
									<td colspan="3" class="text-left">
									  	<div class="input-group mb-3 input-group-sm">
											<!-- 직급 키워드 선택 토글 -->
											<div class="input-group-prepend" style="width:100px">
												<select class="form-select border-1 rounded-0" id="searchJob" name="job">
						...
						<div class="inputRequired mt-3 ml-4 mr-4 row">
							...
							<div class="col-lg-6 form-group">
								...
								<div class="input-group date" id="datetimepicker1" data-target-input="nearest">
				                    <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker1" id="empBirth" name="empBirth" required/>
						...
						<div class="inputRequired mt-3 ml-4 mr-4 row">
							<div class="col-lg-6 form-group">
								...
								<div class="input-group date" id="datetimepicker2" data-target-input="nearest">
				                    <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker2"  name="empJoinDate" required/>
