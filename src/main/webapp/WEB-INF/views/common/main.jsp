...
<body>
	...
	<div align="center">
	<div class="main-content" style="width: 1500px">
		<section class="section h-100">
			<div style="height: 50px">
				
			</div>
			<div class="section-body h-30">
				<h2 class="section-title" style="text-align: left;">내 정보</h2>
				<div class="row mt-sm-4">
					<div class="col-12 col-md-10 col-lg-4 mr-2">
					...
					<div class="col-12 col-md-10 col-lg-7 ml-2">
						<div class="card h-100">
			...
			<div class="section-body">
				...
				<div class="row mt-sm-4 h-100">
					<div class="col-12 col-md-10 col-lg-4 mr-3">
						<div class="card h-100">
							<div class="card-body ">
						<div id="time_Main">
						        ...
						        <div id="Click_io_img">
						            <div class="Io_Click">
						                  <input type="image" class="ioImg" id="startTime" src="${ pageContext.servletContext.contextPath }/resources/img/buttonArrow.png" alt="sdf">
						                <div>출근하기</div>
						                <div id="startTime_area">00:00:00</div>
						            </div>
						            <div class="Io_Click">
						                <input type="image" class="ioImg" id="endTime" src="${ pageContext.servletContext.contextPath }/resources/img/upArrow.png">
						                <div>퇴근하기</div>
					...
					<div class="col-12 col-md-10 col-lg-7 ml-5">
						<div class="card h-100">
							<div class="card-body text-center h-100">
								<h2>이번 달 근무왕 부서</h2>
								<hr><br>
