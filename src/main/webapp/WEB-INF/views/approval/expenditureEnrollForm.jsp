					...
					<div id="expenditure">
						...
						<table class="table table-bordered float-right" id="approvalLine2">
							...
							<tr>
								...
								<td style="height:15px" id="job2"></td>
							</tr>
							<tr>
								<td id="name2"></td>	
						...
						<table class="table table-bordered float-right" id="approvalLine1">
							...
							<tr>
								...
								<td style="height:15px" id="job1"></td>
							</tr>
							<tr>
								<td id="name1"></td>
								...
								<td>
									<div class="input-group mt-3 mb-3">
					    				<div class="input-group-prepend">
					    					<select class="form-control rounded-1" name="retentionPeriod">
						...
						<table class="table table-bordered mt-3">
							...
							<tr>
								<th>지출자</th>
								<td><input type="text" class="form-control" name="spender" required></td>
							</tr>
							<tr>
								<th>계좌 정보</th>
								<td>
									...
									<div class="input-group">
					    				<div class="input-group-prepend" id="corAccountArea" style="display:none">
					    					<select class="form-control rounded-1" id="corAccount" name="account" disabled>
												...
												<option value="국민은행 454-6666-777">국민은행 454-6666-777</option>		
												<option value="카카오뱅크 3333-76-9876934">카카오뱅크 3333-76-9876934</option>									
											</select>
					    				</div>
				    				</div>
								</td>
							...
							<tr>
								<th>지출 사유</th>
								<td><textarea class="form-control" id="exContent" name="exContent" required></textarea></td>
							</tr>
						</table>	
						...
						<table class="table table-bordered mt-3 text-center" id="exTable">
							...
							<tbody id="exTableTbody">
								<tr>
									<td>
										<input type="date" class="form-control" name="exDateList" tabindex="8" required/>	 
									</td>
									<td>
										<div class="input-group">
						    				<div class="input-group-prepend">
